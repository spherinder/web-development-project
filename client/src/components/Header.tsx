...
import { aButtonClass, buttonClass } from "./tailwindClassNames";
...
const SearchResults = ({ result }: { result: SymbolSearch["result"] }) => {
  ...
  return (
    <ul
      className={`absolute top-12 border-2 w-full rounded-md h-64 overflow-y-scroll ${darkMode
...
const Search = () => {
  ...
  return (
    <div
      className={`flex items-center  border-2 rounded-md relative z-50 w-96 ${darkMode ? "bg-gray-900 border-gray-800" : "bg-white border-neutral-200"
        }`}
    >
      <input
        type="text"
    ...
    <div className="flex flex-wrap">
      ...
      <div className="flex-1"
        ...
        {apiToken === null ? (
          ...
          <LogOutButton />
          <a className={aButtonClass} href="/user">
            My profile
          </a>
        </>}
        <ThemeIcon />
